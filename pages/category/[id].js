...
export default function CategoryDetail({category, subCategories, products:orignalProducts}) {
    const defaultSorting = '_id-desc';
    const defaultFilterValues = category.properties.map(p => ({
        name:p.name,
        value:'all',
    }));
    const [products, setProducts] = useState(orignalProducts);
